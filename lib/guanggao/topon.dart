      ...
      if (value.userLocation != null) {
        switch (value.userLocation) {
          ...
          case InitUserLocation.initUserLocationOutOfEU:
            pbLog("flutter: flutter The location of the listening initial user is not in the EU");
            break;
          case InitUserLocation.initUserLocationUnknown:
            pbLog("flutter: flutter The location of the initial listening user is unknown");
            break;
        }
      }
