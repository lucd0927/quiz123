...
- (void)initFlutterInformation:(FlutterMethodCall*)call result:(FlutterResult)result{
    ...
    // 初始化SDK
    else if ([InitThinkUpSDK isEqualToString:call.method]) {
...
- (void)starToponSDK:(FlutterMethodCall *)call result:(FlutterResult)result{
    ...
    [ATFInitManger initThinkUpSDKAppID:ATFCoconfigurMode.appIdStr appKeyStr:ATFCoconfigurMode.appKeyStr requestError:^(NSError * resultError) {
