...
- (NSArray *)funcinitNameArray{
    if (_funcinitNameArray == nil) {
        _funcinitNameArray = @[SetLogEnabled,SetChannelStr,SetSubchannelStr,SetCustomDataDic,SetExludeBundleIDArray,SetPlacementCustomData,InitThinkUpSDK,SetPresetPlacementConfigPath,GetGDPRLevel,GetUserLocation,ShowGDPRConsentDialog,ShowGDPRAuth,ShowDebugUI,SetDataConsentSet,SetDeniedUploadInfoArray];
    }
