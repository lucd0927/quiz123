...
/// 初始化SDK
+ (void)initThinkUpSDKAppID:(NSString *)appIdStr appKeyStr:(NSString *)appKeyStr requestError:(RequestErrorBlock) requestErrorBlock{
...
+ (void)setPresetPlacementConfigPath:(NSString *)pathStr {
    ...
    ATFLog(@"ATFInitManger::setPresetPlacementConfigPathBundle selector not found");
}
